...
/*
    This script is based on the ext save_close_ce
    https://github.com/avionbg/save_close_ce
*/
/**
 * Add an extra save and close button at the end
 *
 * Class SaveButtonHook
 * @package Emagineurs\EPackage\Hooks
 */
Class ButtonBarHook
{
    /**
    ...
    public function addSaveCloseButton($params, &$buttonBar)
    {
        ...
        if($GLOBALS['TYPO3_CONF_VARS']['EXTENSIONS']['e_package']['enableSaveAndClose'] == 1){                
