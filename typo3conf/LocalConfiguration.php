...
return [
    'BE' => [
        ...
        'installToolPassword' => '$argon2i$v=19$m=65536,t=16,p=1$VncvdUFtZ2cyd3E2eVNpMw$ceij+420SysdYn7QiAN9+kfuYY7q5rmbc8i9GB4ClbQ',
    ...
    'DB' => [
        'Connections' => [
            'Default' => [
                'charset' => 'utf8mb4',
                'dbname' => 'cl_bac_a_sable_v10',
                'driver' => 'mysqli',
                'host' => '127.0.0.1',
                'password' => 'c2m6rmhlg7kj',
                'port' => 3306,
                'tableoptions' => [
                    'charset' => 'utf8mb4',
    ...
    'SYS' => [
        ...
        'devIPmask' => '',
        'displayErrors' => 0,
        'encryptionKey' => 'f9d853fa06b16b3d9501bc8623f23a6a6f05fcbbcf41bfbfe1aeff59d94e0464663183b4fa6e632684e247b4b0631d16',
